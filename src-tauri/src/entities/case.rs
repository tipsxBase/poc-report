...
pub async fn add(case: PocCase) -> RResult<std::result::Result<rbatis::rbdc::db::ExecResult, rbatis::rbdc::Error>>{
...
pub async fn query(case: PocCase, current: u64, size: u64) -> RResult<PageResult<PocCase>> {
  ...
  .unwrap();
  let data: Page<PocCase> = select_list(&rb, &PageRequest::new(current, size), &case).await.unwrap();
...
pub async fn delete(case: PocCase) -> RResult<std::result::Result<rbatis::rbdc::db::ExecResult, rbatis::rbdc::Error>> {
  _ = fast_log::init(
      fast_log::Config::new()
          .console()
          .level(log::LevelFilter::Debug),
...
pub async fn update(case: PocCase) -> RResult<std::result::Result<rbatis::rbdc::db::ExecResult, rbatis::rbdc::Error>> {
